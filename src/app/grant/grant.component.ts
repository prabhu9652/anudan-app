...
export class GrantComponent implements OnInit {
  ...
  constructor(private data: GrantDataService, private route: ActivatedRoute, private router: Router, private submissionDataService: SubmissionDataService, private appComp: AppComponent) {
  }
